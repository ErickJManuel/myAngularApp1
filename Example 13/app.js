...
(function(){
	// we need to let this module know that there is now another module that this module DEPENDS on, so we add the store-products module in this module as a dependency
	...
	*/
	 ...
	 *--------------------------------------------------------------------------*/
	 ...
	 /* Below logic is now going to be pulled from a JSON resource so commenting this out
  	var gems = [
		{
			name: 'Azurite',
